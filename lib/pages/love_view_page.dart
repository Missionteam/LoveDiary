...
import 'package:thanks_diary/widgets/fundomental/love_list.dart';
import 'package:thanks_diary/widgets/util/text.dart';

import '../providers/users_provider.dart';

class LoveViewPage extends ConsumerStatefulWidget {
  LoveViewPage({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => HomePageContentState();
}

class HomePageContentState extends ConsumerState<LoveViewPage> {
